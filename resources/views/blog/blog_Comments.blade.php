...
<h3 class="uppercase text-white less-mar-1 title">Blog Comments</h3>
...
<section>
  <div class="pagenation-holder">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h4 class="uppercase">Blog Comments</h4>
        </div>
        <div class="col-md-6">
          <ol class="breadcrumb">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="ce-feature-box-36 bg-light margin-bottom">
        <img src="images/blog/19.jpg" alt="" class="img-responsive">
         <div class="text-box"> <p class="text-primary">22 August 2019</p>
          <h3 class="title font-weight-4"><a href="#">Praesent mattis commodo augue Aliquam Praesent mattis ornare hendrerit </a></h3>
            <div class="blog-post-info"><span><i class="fa fa-comments-o"></i> 15 Comments</span> <span><i class="fa fa-folder"></i> Business/corporate</span><span><i class="fa fa-thumbs-up"></i> 256 Likes</span> </div>
            <br>
      ...
      <!--end title-->
        ...
        <img src="images/blog/2.jpg" alt="" class="img-responsive">
         <div class="text-box"> <p class="text-primary">22 August 2019</p>
          <a href="#"><h5 class="font-weight-5 less-mar-1">Praesent mattis commodo augue amet</h5></a>
      ...
      <div class="clearfix"></div>
      <br>
      <a class="btn btn-dark-3 btn-large uppercase" href="#"><i class="fa fa-paper-plane" aria-hidden="true"></i> &nbsp;Post Comments</a>
      </div>
      <!--end left col main--> 
