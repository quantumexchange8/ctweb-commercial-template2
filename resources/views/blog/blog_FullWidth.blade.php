...
<h3 class="uppercase text-white less-mar-1 title">Blog Full Width</h3>
...
<div class="pagenation-holder">
  <div class="container">
    <div class="row">
   <div class="col-md-6"> <h4 class="uppercase">Blog Full Width</h4></div>
    <div class="col-md-6">
    <ol class="breadcrumb">
...
<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <img src="images/blog/19.jpg" alt="" class="img-responsive">
         <div class="text-box"> <p class="text-primary">22 August 2019</p>
          <h3 class="title font-weight-4"><a href="#">Praesent mattis commodo augue Aliquam Praesent mattis <br> ornare hendrerit Vestibulum ante </a></h3>
