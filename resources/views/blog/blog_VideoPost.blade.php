...
<h3 class="uppercase text-white less-mar-1 title">Blog Video Post</h3>
...
<section>
  <div class="pagenation-holder">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h4 class="uppercase">Blog Video Post</h4>
        </div>
        <div class="col-md-6">
          <ol class="breadcrumb">
            <li><a href="/home">Home</a></li>
            <li><a href="#">Blog</a></li>
            <li class="current"><a href="#">Blog Video Post</a></li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <div class="bg2-video-wrapper">
       <iframe src="https://www.youtube.com/embed/JY02BTJrrOc" frameborder="0" allowfullscreen=""></iframe>
          </div>
          <!--end video wrapper-->
          <div class="clearfix"></div>
          <br>
          <div class="postinfo-box">
            <h4 class=" uppercase title"><a href="#">Aliquam Rhoncus amet Maecenas sed nisl </a></h4>
            <div class="blog-post-info"><span><i class="fa fa-comments-o"></i> 15 Comments</span> <span><i class="fa fa-folder"></i> Business/Video</span><span><i class="fa fa-thumbs-up"></i> 256 Likes</span> </div>
            <br>
