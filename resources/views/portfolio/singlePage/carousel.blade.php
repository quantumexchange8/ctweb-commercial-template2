         ...
         <div class="header-inner less-height">
           <div class="overlay">
             <div class="text text-center">
               ...
               <h6 class="uppercase text-white sub-title"> Portfolio Carousel</h6>
             </div>
           </div>
         </div>
       </div>
       ...
       <div class="row">
         ...
         <div class="col-md-6">
           <ol class="breadcrumb">
             ...
             <li class="current"><a href="#">Portfolio Carousel</a></li>
           </ol>
         </div>
       </div>
     </div>
...
<div class="item">
<div class="col-md-12">
<img src="images/portfolio/14.jpg" alt="" class="img-responsive">                           
</div> 
...
<div class="item">
<div class="col-md-12">
<img src="images/portfolio/15.jpg" alt="" class="img-responsive">                           
</div> 
