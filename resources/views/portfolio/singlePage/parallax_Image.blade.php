     ...
     <div class="container sec-tpadding-4 sec-bpadding-4">
       <div class="row">
         <div class="col-md-8 col-centered text-center">
           <div class="parallax-text-box"><h3 class="uppercase text-white font-weight-6 title">Portfolio Single Image</h3></div>
           </div>
       </div>
   </div>
       </div>
 ...
 <section>
   <div class="pagenation-holder">
     <div class="container">
       <div class="row">
         <div class="col-md-6">
           <h4>Portfolio Single Image</h4>
         </div>
         <div class="col-md-6">
           <ol class="breadcrumb">
             <li><a href="/home">Home</a></li>
             <li><a href="#">Portfolio</a></li>
             <li class="current"><a href="#">Portfolio Single Image</a></li>
           </ol>
         </div>
       </div>
     </div>
