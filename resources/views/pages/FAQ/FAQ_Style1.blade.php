...
<div class="col-md-12 text-center">
  <div class="logo-middle"><a href="#"> <img src="images/logo/logo-dark.png" alt=""></a></div>
</div>

@section('navbar')
@include('pages.FAQ.FAQ_Navbar')
@endsection
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <ol class="breadcrumb">
            ...
            <li class="current"><a href="#">FAQ Style 1</a></li>
          </ol>
        </div>
      </div>
    </div>
...
<div class="accordion_head"><i class="fa fa-pencil" aria-hidden="true"></i> Praesent mattis commodo<span class="plusminus">+</span>
...
<div class="accordion_head"><i class="fa fa-search" aria-hidden="true"></i> Praesent mattis commodo<span class="plusminus">+</span>
...
<div class="accordion_head"><i class="fa fa-trophy" aria-hidden="true"></i> Praesent mattis commodo<span class="plusminus">+</span>
...
<div class="col-md-4 col-sm-12 col-xs-12 section-white">
          ...
          <div class="pages-sidebar-item">
            ...
            <input type="text" name="name" class="pages-newsletter" value="Search" maxlength="100">
          </div>
          <!--end item holder-->
